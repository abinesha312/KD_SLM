...
class AppConfig:
    ...
    dataset_name: str = "HoangHa/medical-data"
    dataset_subset: str = "RandomQA"
    dataset_split: str = "train"
    max_prepare_rows: int | None = 10000
...
def load_config(config_path: str | Path | None = None) -> AppConfig:
    ...
    return AppConfig(
        ...
        dataset_name=dataset.get("name", "HoangHa/medical-data"),
        dataset_subset=dataset.get("subset", "RandomQA"),
        dataset_split=dataset.get("split", "train"),
        max_prepare_rows=dataset.get("max_prepare_rows"),
